...
#define RAIN 0 //yagmur
#define PLANE_BOING 1 //yüzey inis
#define SEND_VOXELS 2
#define WOOP_WOOP 3
#define CUBE_JUMP 4 
#define GLOW 5 //genisleyen
#define TEXT 6 //rakamlar
#define LIT 7 //aydinlatilmis
#define UNIVERSITY 8 //fu
...
//I wrote the name of my own school and department here
uint8_t cube[8][8];
//You must also change the array dimensions according to the code you typed.
uint8_t letter[36][8] = {
{0x7E, 0x02, 0x02, 0x1E, 0x02, 0x02, 0x02, 0x02}, //F
{0x3E, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //I
{0x1E, 0x22, 0x22, 0x22, 0x1E, 0x0A, 0x12, 0x22}, //R
{0x3C, 0x42, 0x42, 0x42, 0x7E, 0x42, 0x42, 0x42}, //A
{0x7F, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08}, //T
{0x22, 0x00, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22}, //Ü
{0x81, 0x83, 0x85, 0x89, 0x91, 0xA1, 0xC1, 0x81}, //N
{0x3E, 0x00, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //İ
{0x00, 0x81, 0x81, 0x42, 0x42, 0x24, 0x24, 0x18}, //V
{0x7E, 0x02, 0x02, 0x1E, 0x02, 0x02, 0x02, 0x7E}, //E
{0x1E, 0x22, 0x22, 0x22, 0x1E, 0x0A, 0x12, 0x22}, //R
{0x7C, 0x02, 0x02, 0x3C, 0x40, 0x40, 0x40, 0x3E}, //S
{0x3E, 0x00, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //İ
{0x7F, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08}, //T
{0x7E, 0x02, 0x02, 0x1E, 0x02, 0x02, 0x02, 0x7E}, //E
{0x7C, 0x02, 0x02, 0x3C, 0x40, 0x40, 0x40, 0x3E}, //S
...
{0x3C, 0x42, 0x42, 0x42, 0x7E, 0x42, 0x42, 0x42}, //A
{0xFF, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0xFF}, //Z
{0x3E, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //I
{0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x7E}, //L
{0x3E, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //I
...
{0x7E, 0x02, 0x02, 0x1E, 0x02, 0x02, 0x02, 0x7E}, //E
{0x81, 0x83, 0x85, 0x89, 0x91, 0xA1, 0xC1, 0x81}, //N
{0x0C, 0x14, 0x24, 0x44, 0x44, 0x24, 0x14, 0x0C}, //D
{0x3E, 0x00, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //İ
{0x3C, 0x42, 0x02, 0x3C, 0x40, 0x40, 0x42, 0x3C}, //S
{0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x7E}, //L
{0x3E, 0x00, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}, //İ
{0x18, 0x3C, 0x42, 0x02, 0x3A, 0x42, 0x42, 0x3C}, //Ğ
{0x3E, 0x00, 0x08, 0x08, 0x08, 0x08, 0x08, 0x3E}  //İ
};
...
void loop() {
  ...
  switch (currentEffect) {
    ...
    case LIT: lit(); break;
    case UNIVERSITY: university("fırat üniversitesi yazılım mühendisliği", 36); break;
...
void university(char string[], uint8_t len) {
  if (loading) {
    clearCube();
    charPosition = -1;
    charCounter = 0;
